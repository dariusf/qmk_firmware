...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT( \
        ...
        KC_ESC,KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,KC_QUOT,KC_NUHS,KC_ENT,      KC_NO,\
        KC_LSPO,KC_NO,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSPC,     KC_UP,  KC_NO,\
        KC_LCTL,KC_LALT,KC_LGUI,               KC_SPC,           MO(1),KC_ENT,  MO(2),     KC_LEFT,KC_DOWN,KC_RGHT \
    ),
    [1] = LAYOUT( \
